...
for drug in ${drugs[@]}
  ...
  for model in ${models[@]}
    ...
    -notsnp \
    -p /home/rhea/account_wflow/phenos/${drug}/${drug}_pheno_no_ids.txt \
    -k /home/rhea/account_wflow/covariates/${drug}/blacks_${drug}.cXX.txt \
    -c /home/rhea/account_wflow/covariates/${drug}/${drug}_covariates.txt \
    -lmm 4 \
