...
### Run Covariates
Create bed/bim/fam files for each drug based on the list of IDs
```{}
plink --bfile /home/rhea/account_wflow/vcfs/preimputation_plinkfiles/ACCOuNTBLACKSfinal_updated --keep /home/rhea/account_wflow/vcfs/blacks_imputed/clop_noac/clop_noac_CrCl_ids_filt.txt --make-bed --out pre_imputed_blacks_clop_noac
```
