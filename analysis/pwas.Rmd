...
This will convert the matrix outputed from PrediXcan to the input for GEMMA.

R file created with `nano` in directory. However, used R in command line to execute code.
